# 🇮🇳 Indian Motor Accident Claims Drafting — Gemini CLI Port

> The same `indian-mact-drafting` pipeline you know, now invokable from Gemini CLI. **Same 6-agent pipeline. Same canonical agent specs. Same filing-grade output. Different LLM brain.**
...
├── skills/ (MACT case-type templates)                   ← case-type templates (unchanged)
├── .gemini/                         ← NEW
│   └── commands/
...
```
<case-folder>/
├── case-config.md + state-config.md           ← advocate-supplied (required)
...
**Forum:** Motor Accident Claims Tribunal (territorial district) / High Court for Section 173 MV Act appeal / Magistrate Court for rash and negligent driving

**Case types covered:** Section 166 MV Act claim · Section 163A no-fault liability · Section 173 appeal · Hit-and-run claim · Insurance Company impleadment · Section 304A IPC / Section 106 BNS criminal complaint · Solatium Fund claim
